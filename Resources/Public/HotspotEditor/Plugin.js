...
var HotspotEditor = (_temp2 = _class = function (_PureComponent) {
    _inherits(HotspotEditor, _PureComponent);
    ...
    function HotspotEditor() {
        ...
        _classCallCheck(this, HotspotEditor);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HotspotEditor.__proto__ || Object.getPrototypeOf(HotspotEditor)).call.apply(_ref, [this].concat(args))), _this), _this.handleChangeCoordinates = function (coordinateValue) {
            _this.props.commit(coordinateValue);
            var customEvent = new CustomEvent('fd-hotspot-editor:hotspotInspectorValueChanged', {
                detail: {
                    coordinateId: _this.props.identifier,
                    coordinateValue: coordinateValue
                }
            });
            window.dispatchEvent(customEvent);
        }, _this.handleHotspotDragged = function (event) {
            _this.props.commit(event.detail.Payload.pos[_this.props.identifier]);
    ...
    _createClass(HotspotEditor, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_reactUiComponents.TextInput, { value: this.props.value, onChange: this.handleChangeCoordinates })
            );
        }
    }]);
...
var _HotspotEditor = __webpack_require__(/*! ./HotspotEditor */ "./src/HotspotEditor.js");

var _HotspotEditor2 = _interopRequireDefault(_HotspotEditor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('FormatD.HotspotEditor:HotspotEditor', {}, function (globalRegistry) {
    var editorsRegistry = globalRegistry.get('inspector').get('editors');
    editorsRegistry.set('FormatD.HotspotEditor/HotspotEditor', {
        component: _HotspotEditor2.default
    });
});
