...
var HotspotEditor = (_temp2 = _class = class HotspotEditor extends _react.PureComponent {
    constructor() {
        var _temp, _this;

        return _temp = _this = super(...arguments), this.handleChangeCoordinates = function (coordinateValue) {
        ...
        }, this.handleHotspotDragged = function (event) {
